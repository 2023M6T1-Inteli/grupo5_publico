...
import {
  ...
  GitHubReposText,
  StartButton,
} from "../../styles/layouts/machinesp2.style";

import NavBar from "../../styles/components/NavBar";

function TutorialMachines(props) {
        ...
        <TemporaryContainer>
          ...
          >
            <Step style={{ borderBottomLeftRadius: "16px" }}>
              ...
              <StepDescription>
                Clique no botão de "+" para adicionar uma máquina.
              </StepDescription>
            </Step>
            <Step>
              <StepTitle>PASSO 2</StepTitle>
              <StepDescription>
                Adicione os dados da máquina.
              </StepDescription>
            </Step>
            <Step>
              <StepTitle>PASSO 3</StepTitle>
              <StepDescription>
                clique em salvar para salvar os dados da máquina.
              </StepDescription>
            </Step>
          </Steps>
        </TemporaryContainer>
...
export default TutorialMachines;
